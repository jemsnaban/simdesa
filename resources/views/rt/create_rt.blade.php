        ...
        <div class="col-md-12">
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Input RT Baru</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" method="post" action="/penduduk/wilayah/rt/create">
              {{ csrf_field() }}
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <select class="form-control select2" name="rt_rw_id" style="width: 100%;">
                    @foreach($rws as $rw)
                      <option value="{{ $rw->id }}">{{ $rw->rw_nama }}</option>
                    @endforeach
                  </select>
                </div>
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="rt_nama" id="exampleInputEmail1" placeholder="Masukkan Nama RW">
                </div>
                <div class="form-group">
